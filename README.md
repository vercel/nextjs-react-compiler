...
* this vendors the [React Compiler (Rust port)](https://github.com/facebook/react/tree/main/compiler) into [`react-compiler/`](./react-compiler)
...
[facebook/react](https://github.com/facebook/react/tree/main/compiler) and was never published, so this repo
